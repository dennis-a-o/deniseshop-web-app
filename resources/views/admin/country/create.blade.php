...
<section class="py-4">
	<div class="row align-items-center justify-content-center">
		<div class="col-6">
			<h4 class="fw-bolder m-0">New country</h4>
		</div>
		<div class="col-6">
			<ol class="breadcrumb justify-content-end align-items-center m-0">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">New country</li>
			 </ol>
		</div>
	</div>
</section>
					...
					<div class="card border-0 rounded-4 p-4">
						<div class="row">
							...
							<div class="col-12">
								...
								<input class="form-control" type="text" name="isocode" placeholder="e.g US or KE" required>
							</div>
							<div class="col-12">
