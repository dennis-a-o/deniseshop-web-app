...
<section class="py-4">
	<div class="row align-items-center justify-content-center">
		<div class="col-6">
			<h4 class="fw-bolder m-0">Order returns</h4>
		</div>
		<div class="col-6">
...
<script type="text/javascript">
	...
	function initTable(){
		...
		data_table.on("click", "#delete-item", function(){
			...
			confirmDelete("Do you really want to delete this order?",
				function(){
					deleteOrderReturn(data_table, _this.dataset.id);
				},
				function(){}
			);
		});
		...
		document.getElementById("bulk-action-btn").addEventListener("click", function(){
			...
			case 'completed':
			case 'cancelled':
				orderReturnStatus(data_table, bulkAction.value);
				break;
			case 'delete':
				confirmDelete("Are you sure you want to delete selected order?<br> This cannot be undone.",
					function(){
						deleteOrderReturn(data_table, 0, true);
					},
					function(){}
				);
				break;
	...
	async function orderReturnStatus(table, status){
		var idArr = [];
	...
	async function deleteOrderReturn(table, id = 0, isBulk = false){
		var idArr = [];
		...
		try{
			const response = await fetch("{{url('/admin/order-return/delete')}}",{
				method: "POST",
				mode: "cors",
				cache: "no-cache",
				credentials: "same-origin",
