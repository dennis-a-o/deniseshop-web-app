...
<section class="py-4">
	<div class="row align-items-center justify-content-center">
		<div class="col-6">
			<h4 class="fw-bolder m-0">New shipping zone</h4>
		</div>
		<div class="col-6">
			<ol class="breadcrumb justify-content-end align-items-center m-0">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">New shipping zone</li>
			 </ol>
		</div>
	</div>
</section>
...
<section>
	<div class="container-fluid p-0">
		<form method="post" action="{{ url('/admin/shipping-zone/create') }}">
			@csrf
			<div class="row">
				<div class="col-lg-9">
					<div class="card border-0 rounded-4 p-4">
						<div class="row">
							...
							<div class="col-12">
								...
								<input type="number" class="form-control" name="rate" min="0" max="100"  required>
							</div>
							<div class="col-12">
