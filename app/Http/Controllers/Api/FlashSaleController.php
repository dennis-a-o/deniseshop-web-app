...
class FlashSaleController extends Controller
{
    ...
    public function flashsaleProducts($flashsale_id, Request $request)
    {
        ...
        $products  = Product::select('products.id', 'products.name', 'products.image', 'products.price', 'products.quantity')
            ...
            ')
            ->join('flash_sales', function(JoinClause $join){
                $join->whereRaw('flash_sales.end_date > CURRENT_DATE');
            })
            ->join('flash_sale_products', function(JoinClause $join){
            ...
            ->where('flash_sales.id', $flashsale_id)
